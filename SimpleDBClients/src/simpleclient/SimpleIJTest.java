...
//	  queries.add("select sname, sid, majorid from student, enroll where sid = studentid");
...
//	  //Non equi
//	  queries.add("select distinct sid, majorid, did, deptid, prof from student, dept, course, section where majorid <> did and did = deptid and cid = courseid");
